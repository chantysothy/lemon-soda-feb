...
(function($) {
  ...
  //      var backgroundImage = $('#image-background');
  //      //backgroundImage.css("background-image", "url('images/image-bg.jpg')");
  //      backgroundImage.backstretch("images/image-bg.jpg");
  //      //backgroundImage.height(imgHeight);
  //      //backgroundImage.width(imgWidth);
  //      backgroundImage.css({ backgroundRepeat: 'no-repeat' });
  //      backgroundImage.show();
  //      //$(".image-background").background("images/image-bg.jpg");
		
		/*====================================
					Clock Countdown
		======================================*/

		//$('#clock-countdown').countdown('2016/12/15 23:59:00').on('update.countdown', function(event) {
